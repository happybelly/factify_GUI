...
public class DNDThreadSingle extends Thread implements DropTargetListener{
	...
	public DNDThreadSingle(){
	}
		
	public DNDThreadSingle(File file, int row_thread){
		this.file = file;
                ...
                if (flavor.isFlavorJavaFileListType()) {
                    ...
                    for (File file : files) {
                    	...
                    	if (Utility.getSuffix(pathsArray.get(i)).equals("pdf")){
                            ...
                            // Thread: Run process          //
                            //////////////////////////////////
                    		service.execute(new DNDThreadSingle(file, i)); //<-----------------------------run sub process here!!
                    		//new DNDThreadFlexible(file, i).start();
