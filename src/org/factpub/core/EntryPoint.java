		...
		if(args.length > 0){
	        ...
	        Option password =
		            OptionBuilder
		                ...
		                .withArgName("password")    //パラメータ名
		                .isRequired(false)    //オプションそのものが必須か
		                .withDescription("password (requires <username>)")    //Usage出力用の説明
		                .withLongOpt("password")    //オプションの別名（--fileとしても可）
		                .create("p");    //fという名前でオプション作成
