...
public class FEWrapper implements FEConstants{
	...
	public static String GUI_Wrapper(File file){
		...
		*/
		...
		int error = extractor.ExtractorBELExtractor.examplePDFExtractor_JSON(args);
	...
	public static void setRuleInputDir(String ruleInputDirPath) {
		ruleInputDir = ruleInputDirPath;
	}
	
	public static String getRuleInputDir(){
		return ruleInputDir;
	}
}
//package org.factpub.core;
